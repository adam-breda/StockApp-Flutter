...
import '../controllers/toploser_controller.dart';

class TopLoserView extends GetView<TopLoserController> {
  TopLoserView({Key? key}) : super(key: key);
  TopLoserController controller = Get.put(TopLoserController());
  @override
