...
class SubscriberProfileController extends GetxController {
  ...
  Future<void> SubscriberKu() async {
    try {
      print("Fetching all subscriber");
      ...
      if (response.statusCode == 200) {
        ...
        var result = jsonDecode(response.body)['data'][0]['existing'];
        // DateTime tanggal =
  ...
  //     var apiUrl = 'http://env-4734168.user.cloudjkt01.com/api/reporthistory/$year';
